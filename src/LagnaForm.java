...
public class LagnaForm {
    public static void main(String[] args) {

        Scanner input = new Scanner(System.in);

        System.out.println("සුබ දවසක් සාදරයෙන් පිලිගන්නවා ලග්න පලා පල වලට.!");
        System.out.println("------------------------------------------");
        System.out.println("කරුනකර මුරපදය සහ නම සදහන් කරන්න");

        String userName = "user@login";
        int password = 1234;

        System.out.print("මුර නම අතුලත් කරන්න:");
        String uName = input.next();

        System.out.print("මුරපදය අතුලත් කරන්න:");
        int uPassword = input.nextInt();
        System.out.println(" ");


        if (userName.equals(uName) && password == uPassword){
            ...
            System.out.println("ඔබග් මුරපදය වැරදී..!");
        }
